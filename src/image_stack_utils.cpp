...
/**
   ...
   \param[in] _marray input multi-dim array, _marray is expected to be defined in c_storage_order
...
std::ostream& operator<<(std::ostream& _cout, const image_stack& _marray){
  ...
  _cout << "\n";
  _cout << std::setfill('-') << std::setw((shapes[2]+1)*9) << " " << std::setfill(' ')<< std::endl ;
