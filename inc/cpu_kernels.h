...
void computeQuotient(const TransferT* _input, TransferT* _output,
                     const SizeT& _size) {
...
void serial_final_values(TransferT* _psi, const TransferT* _integral,
...
void computeFinalValues(TransferT* _psi, const TransferT* _integral,
                        const TransferT* _weight, size_t _size, size_t _offset,
                        double _lambda = 0.006, TransferT _minValue = .0001f) {
  using std::isinf;
  using std::isnan;
...
#include <omp.h>
template <typename TransferT, typename SizeT>
void parallel_divide(const TransferT* _input, TransferT* _output,
...
template <typename TransferT>
void parallel_final_values(TransferT* _psi, const TransferT* _integral,
                           const TransferT* _weight, const size_t& _size,
...
//
template <typename TransferT>
void parallel_regularized_final_values(
    TransferT* _psi, const TransferT* _integral, const TransferT* _weight,
    const size_t& _size, double _lambda = 0.006, const int& _num_threads = -1,
    const TransferT& _minValue = 0.0001f, const size_t& _offset = 0) {
  using std::isinf;
  using std::isnan;
